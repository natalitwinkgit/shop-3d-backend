...
productStyleSchema.pre("validate", function normalizeProductStyle(next) {
...
export default mongoose.models.ProductStyle || mongoose.model("ProductStyle", productStyleSchema);
