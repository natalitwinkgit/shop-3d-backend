...
productRoomSchema.pre("validate", function normalizeProductRoom(next) {
...
export default mongoose.models.ProductRoom || mongoose.model("ProductRoom", productRoomSchema);
